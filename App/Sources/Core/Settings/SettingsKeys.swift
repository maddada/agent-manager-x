...
enum SettingsKeys {
    ...
    static let miniViewerMakeWholeCardHoverable = "agent-manager-x-mini-viewer-make-whole-card-hoverable"
    static let miniViewerCollapseDelayMilliseconds = "agent-manager-x-mini-viewer-collapse-delay-milliseconds"
